...
parser.add_argument("--type", default="full", type=str, help="Type of evaluation; one of 'single' for evaluation of one task or 'full' for evaluation of an entire set.")
parser.add_argument("--set", default="python_validation", type=str, help="Name of the evaluated set - it is a directory containing maze runs")
...
parser.add_argument("--verbose", default=0, type=int, help="Level of verbosity: '0' - prints only the final result, '1' - prints every maze run result, '2' - prints every page result.")
